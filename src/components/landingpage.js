...
export default class landingpage extends Component {
  componentDidMount() {
    const myElement = document.querySelector("#animatedText");
    init(myElement, {
      showCursor: false,
        ...
        <div className="intro">
          ...
          <div className="landing-text">
            ...
            <p className="introText">
              Javascript | Python | Java | Node.js | HTML | CSS | React |
              MongoDB
            </p>
          ...
          <div className="landing-intro">
            ...
            <div className="rightSide">
              ...
              <h2 className="noMarginText">
                I am a{" "}
                <span id="animatedText" className="blackShadowText"></span>
              </h2>
